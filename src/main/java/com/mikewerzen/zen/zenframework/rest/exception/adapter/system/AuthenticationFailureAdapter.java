...
import com.mikewerzen.zen.zenframework.exception.system.AuthenticationFailureException;
...
public class AuthenticationFailureAdapter extends RestThrowableAdapter
{
	...
	{
		return ZenExceptionCodes.AUTH_FAILURE_HTTP_STATUS;
	}

	@Override
	public long getExceptionCode(Throwable throwable)
	{
		return ZenExceptionCodes.AUTH_FAILURE_CODE;
	}

	@Override
	public String getExceptionMessage(Throwable throwable)
	{
		return ZenExceptionCodes.AUTH_FAILURE_MESSAGE;
	}
