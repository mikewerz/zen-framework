...
import com.mikewerzen.zen.zenframework.exception.logic.DataNotFoundException;
...
public class DataNotFoundAdapter extends RestThrowableAdapter
{
	...
	{
		return ZenExceptionCodes.NOT_FOUND_HTTP_STATUS;
	}

	@Override
	public long getExceptionCode(Throwable throwable)
	{
		return ZenExceptionCodes.NOT_FOUND_CODE;
	}

	@Override
	public String getExceptionMessage(Throwable throwable)
	{
		return ZenExceptionCodes.NOT_FOUND_MESSAGE;
	}
