...
package com.mikewerzen.zen.zenframework.rest.response;

public class ZenErrorResponse
{
	ZenError error;

	public ZenErrorResponse()
	{

	}

	public ZenErrorResponse(ZenError error)
	{
		this.error = error;
	}

	public ZenError getError()
	{
		return error;
	}
}
