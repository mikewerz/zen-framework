...
import com.mikewerzen.zen.zenframework.exception.system.DatabaseException;
...
public class DatabaseThrowableAdapter extends RestThrowableAdapter
{
	...
	{
		super(DatabaseException.class, SQLException.class, DataAccessException.class, HibernateException.class);
	}

	@Override
	public HttpStatus getHttpStatus(Throwable throwable)
	{
		return ZenExceptionCodes.DATABASE_ERROR_HTTP_STATUS;
	}

	@Override
	public long getExceptionCode(Throwable throwable)
	{
		return ZenExceptionCodes.DATABASE_ERROR_CODE;
	}

	@Override
	public String getExceptionMessage(Throwable throwable)
	{
		return ZenExceptionCodes.DATABASE_ERROR_MESSAGE;
	}
