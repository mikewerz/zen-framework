...
import com.mikewerzen.zen.zenframework.exception.system.UnknownException;
...
public class UnknownThrowableAdapter extends RestThrowableAdapter
{
	...
	{
		return ZenExceptionCodes.UNKNOWN_ERROR_HTTP_STATUS;
	}

	@Override
	public long getExceptionCode(Throwable throwable)
	{
		return ZenExceptionCodes.UNKNOWN_ERROR_CODE;
	}

	@Override
	public String getExceptionMessage(Throwable throwable)
	{
		return ZenExceptionCodes.UNKNOWN_ERROR_MESSAGE;
	}
