...
{
	public InvalidAuthenticationAdapter()
	{
		super(InvalidAuthenticationException.class);
	}

	@Override
	public HttpStatus getHttpStatus(Throwable throwable)
	{
		return ZenExceptionCodes.INVALID_AUTHENTICATION_HTTP_STATUS;
	}
	
	@Override
	public long getExceptionCode(Throwable throwable)
	{
		return ZenExceptionCodes.INVALID_AUTHENTICATION_CODE;
	}

	@Override
	public String getExceptionMessage(Throwable throwable)
	{
		return ZenExceptionCodes.INVALID_AUTHENTICATION_MESSAGE;
	}
