...
import com.mikewerzen.zen.zenframework.exception.system.RemovedException;
...
public class RemovedThrowableAdapter extends RestThrowableAdapter
{
	...
	{
		return ZenExceptionCodes.REMOVED_HTTP_STATUS;
	}

	@Override
	public long getExceptionCode(Throwable throwable)
	{
		return ZenExceptionCodes.REMOVED_CODE;
	}

	@Override
	public String getExceptionMessage(Throwable throwable)
	{
		return ZenExceptionCodes.REMOVED_MESSAGE;
	}
